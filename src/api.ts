...
export default class Api {
    private static readonly sources: (Module | CModule)[] = [];
    ...
    static initSources(library: Module, unityVersion: UnityVersion) {
        this.sources.push(library, this.getMissingExports(unityVersion));
    }
...
#if ${unityVersion.isEqualOrAbove_5_3_3}
...
#if ${unityVersion.isBelow_2019_3_0}
size_t
...
#if ${unityVersion.isEqualOrAbove_5_5_0}
...
{
    const char * name;
#if ${unityVersion.isEqualOrAbove_2017_1_3 && unityVersion.isNotEqual_2017_2_0}
...
#endif
#if ${unityVersion.isBelow_2020_2_0}
    int32_t typeStart;
#endif
    uint32_t typeCount;
#if ${unityVersion.isEqualOrAbove_2017_1_0}
#if ${unityVersion.isBelow_2020_2_0}
...
#endif
#if ${unityVersion.isEqualOrAbove_2020_2_0}
...
#endif
#if ${unityVersion.isEqualOrAbove_2019_1_0}
    const struct Il2CppCodeGenModule * codeGenModule;
#endif
#if ${unityVersion.isEqualOrAbove_5_3_2}
    uint32_t token;
#endif
#if ${unityVersion.isEqualOrAbove_2018_1_0}
    uint8_t dynamic;
...
#if ${unityVersion.isBelow_2018_3_0}
uint32_t
...
#if ${unityVersion.isBelow_2018_1_0}
uint
...
#endif
#if ${unityVersion.isEqualOrAbove_5_6_0}
...
#if ${unityVersion.isEqualOrAbove_5_3_6 && unityVersion.isBelow_5_5_0}
    VirtualInvokeData * vtable;
#endif
#if ${unityVersion.isBelow_5_3_6}
...
#endif
#if ${unityVersion.isEqualOrAbove_2018_2_0}
...
#if ${unityVersion.isEqualOrAbove_5_4_4 && unityVersion.isNotEqual_5_5_0}
    uint8_t genericRecursionDepth;
#endif
    uint8_t rank;
    uint8_t minimumAlignment;
#if ${unityVersion.isEqualOrAbove_2018_3_8}
